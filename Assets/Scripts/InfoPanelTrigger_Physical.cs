...
public class InfoPanelTrigger_Physical : MonoBehaviour
{
    [Header("Timings")]
    [Tooltip("Tiempo que el dedo debe mantener la pulsación para activarla (ej: 0.5s).")]
    public float requiredPressDuration = 0.5f;
    ...
    void Start()
    {
        ...
        Debug.Log("No encontré el manager de InfoPanelManager");
        if (buttonImage != null)
        {
            buttonImage.color = normalColor;
        }
    ...
    public void OnRaycastEnter()
    {
        ...
        if (buttonImage != null)
        {
            ...
            Debug.Log("Raycast Enter - Cambiando a color PRESSED");
            buttonImage.color = pressedColor; 
        }
    }
