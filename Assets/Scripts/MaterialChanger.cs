...
//     private const float COOLDOWN_TIME = 5f; // Tiempo de espera entre swipes
...
//         Debug.Log($"Modo de cambio de material: {(enable ? "ACTIVADO" : "DESACTIVADO")}");
//     }
...
//         // Si la funcionalidad no está habilitada por el control externo, salimos inmediatamente.
//         if (!isMaterialChangeEnabled)
//         {
//             return;
//         }
//         // También puedes añadir la condición del InspectableObject aquí si es necesario:
//         // if (interactionController != null && !interactionController.IsInteractionActive()) return;
